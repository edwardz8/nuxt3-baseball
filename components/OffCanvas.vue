<script setup>
import PolarChartArea from "~/components/PolarChartArea";
  ...
  <div>
    <Transition name="slide-fade">
      <div
        v-if="player"
        id="player-sidebar"
        class="hs-overlay translate-x-0 fixed top-0 left-0 transition-all duration-100 transform h-full max-w-xs w-full z-[60] bg-white border-r"
        tabindex="-1"
      >
        <div
