    ...
    <section>
      ...
      <div v-if="player" class="gap-3 px-4">
        ...
        <button
          ...
          type="button"
          @click="likePlayer"
          class="mt-3 py-2 px-2 inline-flex justify-center items-center gap-2 rounded-md border-2 border-gray-900 font-semibold text-gray-600 hover:bg-gray-200 hover:border-gray-800 focus:outline-none transition-all text-sm"
        >
          <svg
            width="20"
            height="18"
